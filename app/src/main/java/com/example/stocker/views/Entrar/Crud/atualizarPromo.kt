...
import com.example.stocker.databinding.ActivityAtualizarPromoBinding
import com.example.stocker.views.Entrar.Estatistica.detalhesPromo
import com.google.firebase.firestore.DocumentSnapshot
import com.google.firebase.firestore.FirebaseFirestore
import com.google.android.material.snackbar.Snackbar

class atualizarPromo : AppCompatActivity() {
    private lateinit var binding: ActivityAtualizarPromoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAtualizarPromoBinding.inflate(layoutInflater)
    ...
    private fun telaPrincipal(){
        val perfilT = Intent(this, detalhesPromo::class.java)
