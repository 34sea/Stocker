...
import com.example.stocker.databinding.ActivityDetalhesPromoBinding
import com.example.stocker.databinding.ActivityDetalhesVendaBinding
...
class detalhesVenda : AppCompatActivity() {
    private lateinit var binding: ActivityDetalhesVendaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetalhesVendaBinding.inflate(layoutInflater)
