...
class detalhesPromo : AppCompatActivity() {

    private lateinit var binding: ActivityDetalhesPromoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDetalhesPromoBinding.inflate(layoutInflater)
